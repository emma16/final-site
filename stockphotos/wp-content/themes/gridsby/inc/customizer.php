...
function gridsby_theme_customizer( $wp_customize ) {
	...
	$wp_customize->add_section( 'gridsby_category_section', array(
		'title'          => __( 'Category Gallery', 'gridsby' ), 
		'priority'       => 35,
		'description' => __( 'Select the layout of your category gallery.', 'gridsby' ),
	)); 
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'gridsby_category_layout', array(
		'label'	   =>  __( 'Category Layout', 'gridsby' ),
		'section'  => 'gridsby_category_section', 
		'settings' => 'gridsby_category_layout',
		'type'     => 'radio', 
		'priority'    => 10, 
		'choices'  => array(
			'option1' => __( 'Full-width Gallery', 'gridsby' ),
			'option2' => __( 'Gallery with Sidebar', 'gridsby' ),
			),
	))); 
    ...
    $wp_customize->add_control( 'gridsby_category_num_posts', array(  
        ...
        'priority'    => 30,
        'section'     => 'gridsby_category_section', 
        'label'       => __('Number of Photos', 'gridsby'),
        'description' => __('Choose the number of photos to display on your category galleries (0 shows all)', 'gridsby'),  
        'input_attrs' => array(
            'min'   => -1, 
            'max'   => 200,
